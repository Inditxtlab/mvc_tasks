...
<!-- Champ caché pour l'ID de la tâche : Le champ input type="hidden" permet d'envoyer l'ID de la tâche dans le formulaire sans l'afficher à l'utilisateur. La valeur de ce champ est récupérée via $task->getId(), probablement un objet qui représente la tâche à modifier. -->
